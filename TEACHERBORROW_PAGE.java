...
//LINE
         ...
         f.add(teachlblname);
         f.add(teachlname);
         teachlblname.setFont(txtlbl);
         teachlname.setFont(txtbox);
         ...
         f.add(teachlblfname);
         f.add(teachfname);
         teachlblfname.setFont(txtlbl);
         teachfname.setFont(txtbox);
         ...
         f.add(lblempid);
         f.add(employeeid);
         lblempid.setFont(txtlbl);
         employeeid.setFont(txtbox);
         ...
         String[] cllg = {"HUMAN KINETICS", "COMPUTING AND INFORMATION SCIENCES","COLLEGE OF ARTS AND LETTERS", "BUSINESS AND FINANCIAL SCIENCE","TOURISM AND HOSPITALITY MANAGEMENT","INSTITUTE OF NURSING", "HIGHER SCHOOL NG UMAK" };
